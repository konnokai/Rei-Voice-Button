...
.vo-btn-bg-light {
  background: linear-gradient(to right, #63a1c9 var(--start-percent), #cae0ee var(--progress));
}

.vo-btn-bg-dark {
  background: linear-gradient(to right, #0f3543 var(--start-percent), #105078 var(--progress));
}
